...
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md#tema-0--por-qué-existe-fhir--el-diagnóstico-institucional): diagnóstico de interoperabilidad actual de la institución.
...
- Quiz: `--dia 1` y `--dia 2`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): escribe el `Patient` salvadoreño (DUI ficticio, dos apellidos, municipio).
...
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): ciclo CRUD completo de tu expediente ficticio contra HAPI.
...
- Quiz: `--dia 6`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): matriz de scopes SMART por actor (médico, enfermería, farmacia, reportes MINSAL).
...
- Quiz: `--dia 12`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): modela una consulta externa completa con recursos enlazados.

## Tema 5 · Búsqueda avanzada
- Lectura: [movil/tema-05-busqueda.md](movil/tema-05-busqueda.md)
- Práctica: [dia-18](dias/dia-18/README.md)
- Quiz: `--dia 18`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): las 5 búsquedas operativas diarias de la institución como URLs FHIR.
...
- Quiz: `--dia 11`, `--dia 19`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): catálogo de 10 conceptos con SNOMED/LOINC + mini-ValueSet institucional.
...
- Quiz: `--dia 15`, `--dia 16`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): borrador del profile PacienteDoctorSV + `$validate` con análisis del OperationOutcome.
...
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): piloto `doctorsv-piloto` en GCP con tus recursos, cerrando en costo $0.
...
- Quiz: `--dia 17`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): flujo Backend Services para reportes epidemiológicos nocturnos.
...
- Quiz: `--dia 13`, `--dia 14`
- [Práctica DoctorSV](PRACTICAS-DOCTORSV.md): la propuesta final "Interoperabilidad FHIR para DoctorSV" con tus 10 entregables.
...
- Cada tema tiene una **práctica institucional** (el enlace "Práctica DoctorSV"):
  un entregable aplicado a DoctorSV que haces al cerrar el tema (30-90 min). El
  detalle completo de las 11 prácticas está en
  [PRACTICAS-DOCTORSV.md](PRACTICAS-DOCTORSV.md); los entregables se guardan en
  `institucion/tema-XX/`.
- Al completar la ruta, esos 11 entregables se unen en la propuesta
  **"Interoperabilidad FHIR para DoctorSV"** (Tema 10) — evidencia presentable
